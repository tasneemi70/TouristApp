...
var PlaceList = [
    ...
    abhPlace(image: "4", name: "KAYA Cafe ⠀⠀", placeA: [
        PlaceInformation(PlaceImage0: "a1",PlaceImage1: "a2", PlaceImage2: "a3", PlaceImage3: "4" ,PlaceName: "KAYA cafe ☕️", auther: "jkefc")
      ]),
      abhPlace(image: "5", name: "High City ⠀⠀", placeA: [
        PlaceInformation(PlaceImage0: "s1",PlaceImage1: "s2", PlaceImage2: "s3", PlaceImage3: "s4", PlaceName: "high city 🏞", auther: "ecwec"),
      ]),
      abhPlace(image: "t1", name: "AZIZAH ⠀⠀ ", placeA: [
        PlaceInformation(PlaceImage0: "2",PlaceImage1: "t2", PlaceImage2: "t3", PlaceImage3: "t4", PlaceName: "AZIZAH ⛰", auther: "ecwf")
      ]),
